  ...
  return (
    <div className="space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4">
        <div>
          <h2 className="text-2xl font-semibold text-gray-800 tracking-tight uppercase">Data Backup & Restore</h2>
      ...
      {showRestoreConfirm && selectedBackup && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-md max-w-md w-full p-6 space-y-4">
