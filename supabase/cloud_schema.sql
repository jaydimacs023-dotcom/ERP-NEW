...
CREATE OR REPLACE FUNCTION "public"."billing_course_fee_invoice"("p_batch_id" "uuid", "p_sponsor_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("course_fee_id" "uuid", "description" "text", "quantity" integer, "unit_price" numeric, "amount" numeric, "line_type" "text", "gl_account_id" "uuid", "tax_category_id" "uuid")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."billing_course_fee_invoice"("p_batch_id" "uuid", "p_sponsor_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."billing_valid_enrolled_qty"("p_batch_id" "uuid", "p_sponsor_id" "uuid" DEFAULT NULL::"uuid") RETURNS integer
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."billing_valid_enrolled_qty"("p_batch_id" "uuid", "p_sponsor_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."billing_valid_enrollments"("p_batch_id" "uuid", "p_sponsor_id" "uuid" DEFAULT NULL::"uuid") RETURNS SETOF "public"."enrollments"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select e.*
...
ALTER FUNCTION "public"."billing_valid_enrollments"("p_batch_id" "uuid", "p_sponsor_id" "uuid") OWNER TO "postgres";
