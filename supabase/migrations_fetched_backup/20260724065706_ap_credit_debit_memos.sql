...
grant select, insert, update on public.ap_memos to anon, authenticated;
...
revoke all on function public.ap_memo_actor_allowed(uuid,uuid) from public;
revoke all on function public.next_ap_memo_number(uuid,text,date,uuid) from public;
revoke all on function public.submit_ap_memo(uuid,uuid) from public;
revoke all on function public.post_ap_memo(uuid,uuid) from public;
revoke all on function public.reverse_ap_memo(uuid,uuid,text) from public;
revoke all on function public.cancel_ap_memo(uuid,uuid,text) from public;
grant execute on function public.next_ap_memo_number(uuid,text,date,uuid) to anon,authenticated;
grant execute on function public.submit_ap_memo(uuid,uuid) to anon,authenticated;
grant execute on function public.post_ap_memo(uuid,uuid) to anon,authenticated;
grant execute on function public.reverse_ap_memo(uuid,uuid,text) to anon,authenticated;
grant execute on function public.cancel_ap_memo(uuid,uuid,text) to anon,authenticated;
