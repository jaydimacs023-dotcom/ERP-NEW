          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#F47721] px-8 py-3.5 text-sm font-semibold uppercase tracking-[0.18em] text-white shadow-[0_18px_50px_rgba(244,119,33,0.35)] transition-all hover:bg-[#E06610] active:scale-95"
              >
                Login
                <ArrowRight size={16} />
              </button>
